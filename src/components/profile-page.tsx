...
import { Copy, Check, Zap, Sparkles, Rocket, Building2, ChevronDown, Globe } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            >
                ...
                <p className="text-xs text-white/30 mt-2">
                    ...
                    {language === 'ru' ? 'кредитов в месяц' : 'credits per month'}
                </p>
            </motion.div>
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-3 bg-white/[0.03] rounded-full p-1">
                        ...
                        >
                            ...
                            <span className="px-1.5 py-0.5 rounded text-[10px] font-bold bg-[#53FF45] text-black">
                                -40%
                            </span>
                        </button>
                    </div>
                                ...
                                <div className="relative z-10">
                                    <div className="mb-5 mt-3 flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            <div
                                                className={`p-2 rounded-xl bg-gradient-to-br ${config.gradient} shadow-lg`}
                                            >
                                                {config.icon}
                                            </div>
                                    ...
                                    <div className="mb-5 flex flex-col">
                                        ...
                                        <div className="flex items-baseline">
                                            <span
                                                ...
                                                style={{
                                                    color:
                                                        plan.price > 0 ? config.accent : '#a1a1aa',
                                                }}
                                            >
                                                {displayPrice === 0
                                                    ? '0'
                                        ...
                                        {isAnnual && originalPrice > 0 && (
                                            <div
                                                className="mt-2 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-medium w-fit"
                                                style={{
                                            ...
                                            >
                                                <Sparkles className="w-3 h-3" />
                                                {language === 'ru' ? 'Экономия' : 'Save'}{' '}
                                                {Math.round(
                                                    originalPrice * 12 * annualDiscount,
                                                ).toLocaleString()}
                                                ₽/{language === 'ru' ? 'год' : 'yr'}
                                            </div>
                                        )}
                                    ...
                                    <div className="mb-5 p-3 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <span className="text-[#FFDC74] font-bold text-lg">
                                    ...
                                    <div className="space-y-2.5">
                                        {(language === 'ru' ? plan.features : plan.featuresEn)
                                            .slice(0, 4)
                                            .map((feature, i) => (
                                                <div
                                                    key={i}
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h2 className="text-xl font-bold">
                                {language === 'ru' ? 'Пакеты кредитов' : 'Credit Packages'}
                            </h2>
                        </div>
                    ...
                    <div className="flex items-center justify-between py-3">
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <ChevronDown
                                    className={`w-4 h-4 text-white/40 transition-transform ${langDropdownOpen ? 'rotate-180' : ''}`}
                                    aria-hidden="true"
                                />
                            </button>
                            {langDropdownOpen && (
                                <>
                                    ...
                                    <div className="absolute right-0 top-full mt-1 w-40 rounded-xl bg-[#1a1a1a] border border-white/10 shadow-xl overflow-hidden z-50">
                                        ...
                                        >
                                            ...
                                            {language === 'ru' && (
                                                <Check
                                                    className="w-4 h-4 ml-auto text-[#53FF45]"
                                                    aria-hidden="true"
                                                />
                                            )}
                                        </button>
