...
const TEMPLATES = [
    ...
    },
    {
        ...
        prompt_ru:
            'Модель в роскошном красном шелковом платье, фон улицы Парижа, реалистичное освещение',
        prompt_en:
            'Fashion model wearing a luxury red silk dress, Paris street background, realistic lighting',
...
// Fallback gallery items for type reference
const GALLERY_ITEMS: GalleryItem[] = [
    { image: '', aspectRatio: 'square' },
    { image: '', aspectRatio: 'vertical' },
...
const TOOLS = [
    ...
    },
    {
        ...
        hoverImage:
            'https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/010102a2-9a78-497c-a40c-16883620b037/upscale_hover-1768346852404.png?width=8000&height=8000&resize=contain',
        ...
        <div className="max-w-6xl mx-auto space-y-24 pb-32 relative">
            ...
            <div
                ...
                style={{
                    ...
                    WebkitMaskImage:
                        'radial-gradient(circle at 50% 0%, black 10%, transparent 75%)',
                }}
            />
